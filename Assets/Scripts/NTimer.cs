...
namespace UndeadAssault
{
    public class NTimer
    {
        ...
        )
        {
            ...
            NTimer._manager.RegisterTimer(timer);
            return timer;
        }
        ...
        public static void Cancel(NTimer timer)
        {
            if (timer != null)
            {
                timer.Cancel();
        ...
        public static void Pause(NTimer timer)
        {
            if (timer != null)
            {
                timer.Pause();
        ...
        public static void Resume(NTimer timer)
        {
            if (timer != null)
            {
                timer.Resume();
        ...
        public static void CancelAllRegisteredTimers()
        {
            if (NTimer._manager != null)
            {
                NTimer._manager.CancelAllTimers();
            }
        ...
        public static void PauseAllRegisteredTimers()
        {
            if (NTimer._manager != null)
            {
                NTimer._manager.PauseAllTimers();
            }
        ...
        public static void ResumeAllRegisteredTimers()
        {
            if (NTimer._manager != null)
            {
                NTimer._manager.ResumeAllTimers();
            }
        ...
        /// <summary>
        /// Manages updating all the <see cref="NTimer"/>s that are running in the application.
        /// This will be instantiated the first time you create a timer -- you do not need to add it into the
        /// scene manually.
        /// </summary>
        private class TimerManager : MonoBehaviour
        {
            private List<NTimer> _timers = new List<NTimer>();

            // buffer adding timers so we don't edit a collection during iteration
            private List<NTimer> _timersToAdd = new List<NTimer>();

            public void RegisterTimer(NTimer timer)
            {
            ...
            {
                foreach (NTimer timer in this._timers)
                {
                    timer.Cancel();
                }

                this._timers = new List<NTimer>();
                this._timersToAdd = new List<NTimer>();
            }
